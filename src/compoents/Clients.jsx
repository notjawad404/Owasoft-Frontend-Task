      ...
      <div className="flex justify-center pt-10 pb-2">
        <div className="flex flex-wrap">
          {firstRowClients.map((client, index) => (
            <div className=" bg-blue-100 bg-opacity-90 px-6 rounded-[55px] mx-4" key={index}>
      ...
      <div className="flex justify-center py-2">
        <div className="flex flex-wrap">
          {secondRowClients.map((client, index) => (
            <div className=" bg-blue-100 bg-opacity-90 px-6 rounded-[55px] mx-4" key={index+5}>
            <img src={client.img} alt="client" className="m-2 w-20 h-12" />
            </div>
          ))}
        </div>

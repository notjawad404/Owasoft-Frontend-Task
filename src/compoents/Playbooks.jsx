...
export default function Playbooks() {
  ...
  return (
    <div className="playbook_bg pt-40 pb-72 px-16 flex flex-row">
        ...
        <h1 className=" font-bold text-4xl">Send the right message, at the right time</h1>
        <p className=" font-base text-xl py-10">Empower website owners with our platform&apos;s secure, intuitive alert management system, enriched with advanced analytics for insightful performance tracking.</p>
